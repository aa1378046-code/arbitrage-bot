...
# ===== ПАРАМЕТРЫ СТРАТЕГИИ =====
MIN_FUNDING = 0.08           # минимальный фандинг %
MIN_FUNDING_PERIODS = 2      # минимум периодов подряд с положительным фандингом
MIN_VOLUME_24H = 50_000_000  # минимальный оборот $50M
MAX_SPREAD = 0.3             # максимальный спред фьючерс/спот %
MIN_PROFIT_AFTER_FEES = 0.02 # минимальная чистая прибыль после комиссий %
TAKER_FEE = 0.055            # комиссия тейкера Bybit (%)
MIN_MINUTES_TO_FUNDING = 30  # минимум минут до выплаты
MAX_PRICE_CHANGE_1H = 3.0    # максимальное движение цены за час %
MONITOR_INTERVAL = 300        # интервал мониторинга (сек)
MIN_RISK_SCORE = 6            # минимальная оценка риска для сигнала
